...
g_c_p_cloudfunctions_functions_create_tests: List[PantherRuleTest] = [
    PantherRuleTest(
        ...
        Log={
            "protoPayload": {
                "authorizationInfo": [
                    {"granted": True, "permission": "cloudfunctions.functions.create"}
                ],
    ...
    PantherRuleTest(
        ...
        Log={
            "protoPayload": {
                "authorizationInfo": [
                    {"granted": False, "permission": "cloudfunctions.functions.create"}
                ],
                "methodName": "v2.deploymentmanager.deployments.insert",
                "serviceName": "deploymentmanager.googleapis.com",
            },
...
class GCPCloudfunctionsFunctionsCreate(PantherRule):
    ...
    Tests = g_c_p_cloudfunctions_functions_create_tests
