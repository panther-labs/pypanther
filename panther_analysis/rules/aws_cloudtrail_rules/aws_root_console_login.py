...
a_w_s_cloud_trail_root_console_login_tests: List[PantherRuleTest] = [
    PantherRuleTest(
...
class AWSCloudTrailRootConsoleLogin(PantherRule):
    RuleID = "AWS.CloudTrail.RootConsoleLogin-prototype"
    ...
    Runbook = "Verify that the root login was authorized. If not, investigate the root activity and ensure no malicious activity was performed. Change the root password.\n"
    ...
    Tests = a_w_s_cloud_trail_root_console_login_tests
