            ...
            "data": {
                ...
                "details": {
                    "request": {
                        ...
                        "body": {"name": "admin", "description": "some new role"},
                        "channel": "https://manage.auth0.com/",
                        "ip": "12.12.12.12",
                        "method": "put",
                        "path": "/api/v2/guardian/policies",
...
class Auth0CustomRoleCreated(Auth0Rule):
    ...
    def rule(self, event):
        ...
        return all([data_description == "Create a role", self.is_auth0_config_event(event)])
