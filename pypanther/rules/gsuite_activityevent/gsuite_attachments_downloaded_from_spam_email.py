...
@panther_managed
class GSuiteGmailSpamEmailAttachmentDownload(Rule):
    id = "GSuite.Gmail.SpamEmail.AttachmentDownload-prototype"
    display_name = "Gsuite Attachments Downloaded from Spam Email"
    log_types = [LogType.GSUITE_ACTIVITY_EVENT]
    tags = ["GSuite"]
    reports = {"MITRE ATT&CK": ["TA0001:T1566.001", "TA0011:T1204.002"]}
