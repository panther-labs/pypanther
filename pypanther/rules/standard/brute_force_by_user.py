...
@panther_managed
class StandardBruteForceByUser(Rule):
    id = "Standard.BruteForceByUser-prototype"
    display_name = "Brute Force By User"
    log_types = [
        LogType.ASANA_AUDIT,
    ...
    default_runbook = "Analyze the user ID who failed to login, and other actions taken before/after. Check if this user eventually authenticated successfully."
