...
aws_cloud_trail_user_access_key_auth_tests: list[RuleTest] = [
    RuleTest(
        ...
        log={
            ...
            "p_any_actor_ids": ["AIDASXP6SDP2AJQPWVFII"],
            "p_any_aws_account_ids": ["187901811700"],
            "p_any_aws_arns": ["arn:aws:iam::187901811700:user/exposed.user"],
            "p_any_ip_addresses": ["73.252.165.138"],
            "p_any_trace_ids": ["AKIASXP6SDP2F3JQERZ2"],
            "p_any_usernames": ["exposed.user"],
    ...
    RuleTest(
        ...
        log={
            ...
            "eventVersion": "1.08",
            "managementEvent": True,
            "p_any_actor_ids": ["AROASXP6SDP2F4WLQVARB", "AROASXP6SDP2F4WLQVARB:nicholas.hakmiller"],
            "p_any_aws_account_ids": ["187901811700"],
            "p_any_aws_arns": [
            ...
            "p_any_ip_addresses": ["73.252.165.138"],
            "p_any_trace_ids": ["ASIASXP6SDP2HUZY3TOB"],
            "p_any_usernames": ["AWSReservedSSO_DevAdmin_635426549a280cc6", "nicholas.hakmiller"],
            ...
            "userIdentity": {
                ...
                "sessionContext": {
                    "attributes": {"creationDate": "2024-06-02T19:41:40Z", "mfaAuthenticated": "false"},
                    "sessionIssuer": {
                        "accountId": "187901811700",
    ...
    RuleTest(
        ...
        log={
            ...
            "p_any_ip_addresses": ["73.252.165.138"],
            "p_any_trace_ids": ["ASIASXP6SDP2HUZY3TOB"],
            "p_any_usernames": ["nicholas.hakmiller"],
            "p_event_time": "2024-06-02 19:41:40.000000000",
            "p_log_type": "AWS.CloudTrail",
            "p_parse_time": "2024-06-02 19:50:54.391407154",
            "p_row_id": "f26228572e3f9acd88e0cadc1f80a502",
...
@panther_managed
class AWSCloudTrailUserAccessKeyAuth(Rule):
    id = "AWS.CloudTrail.UserAccessKeyAuth-prototype"
    display_name = "AWS.CloudTrail.UserAccessKeyAuth"
    log_types = [LogType.AWS_CLOUDTRAIL]
    default_severity = Severity.INFO
    inline_filters = [{"All": []}]
    create_alert = False
    tests = aws_cloud_trail_user_access_key_auth_tests
