...
from pypanther.rules.aws_securityfinding.decoy_dynamodb_accessed import (
    decoy_dynamo_db_accessed_tests as decoy_dynamo_db_accessed_tests,
)
from pypanther.rules.aws_securityfinding.decoy_iam_assumed import DecoyIAMAssumed as DecoyIAMAssumed
from pypanther.rules.aws_securityfinding.decoy_iam_assumed import decoy_iam_assumed_tests as decoy_iam_assumed_tests
from pypanther.rules.aws_securityfinding.decoy_s3_accessed import DecoyS3Accessed as DecoyS3Accessed
from pypanther.rules.aws_securityfinding.decoy_s3_accessed import decoy_s3_accessed_tests as decoy_s3_accessed_tests
from pypanther.rules.aws_securityfinding.decoy_secret_accessed import DecoySecretAccessed as DecoySecretAccessed
from pypanther.rules.aws_securityfinding.decoy_secret_accessed import (
    decoy_secret_accessed_tests as decoy_secret_accessed_tests,
)
