...
class CarbonBlackAlertV2Passthrough(PantherRule):
    id_ = "CarbonBlack.AlertV2.Passthrough-prototype"
    default_description = "This rule enriches and contextualizes security alerts generated by Carbon Black.  The alert title and description are dynamically updated based on data included in the alert log."
    ...
    log_types = [PantherLogType.CarbonBlack_AlertV2]
