...
@panther_managed
class Auth0DeleteTenantMember(Rule):
    id = "Auth0.Delete.TenantMember-prototype"
    display_name = "Auth0 Delete Tenant Member"
    log_types = [LogType.AUTH0_EVENTS]
    default_severity = Severity.INFO
    create_alert = False
    reports = {"MITRE ATT&CK": ["TA0010:T1041"]}
    default_description = "A tenant member was deleted."
    default_reference = (
    ...
    def rule(self, event):
        ...
        return all([is_auth0_config_event(event), data_description == "Delete tenant member"])
