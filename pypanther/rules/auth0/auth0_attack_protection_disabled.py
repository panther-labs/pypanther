...
@panther_managed
class Auth0AttackProtectionDisabled(Rule):
    default_description = "An attack protection monitoring configuration was changed."
    display_name = "Auth0 Attack Protection Monitoring Disabled"
    ...
    id = "Auth0.AttackProtection.Disabled-prototype"
    ...
    def rule(self, event):
        ...
        return all(
            [
                ...
                or (
                    "Brute-force" in data_description and request_path == "/v2/attack-protection/brute-force-protection"
                )
                or (
    ...
    def title(self, event):
        ...
        return f"Auth0 User [{user}] updated shields to [{response_body_shields}]or set attack protection monitoring to [{response_body_enabled}]with message [{data_description}] inyour organization's tenant [{p_source_label}]."
            ...
            log={
                "data": {
                    ...
                    "details": {
                        ...
                        "response": {"body": {"enabled": True}, "statusCode": 400},
                    },
                    "ip": "12.12.12.12",
                    "log_id": "90020230523204756343781000000000000001223372037583230452",
                    "type": "sapi",
            ...
            log={
                "data": {
                    ...
                    "details": {
                        ...
                        "response": {"body": {"enabled": True, "shields": "user_notification"}, "statusCode": 200},
                    },
                    "ip": "12.12.12.12",
                    "log_id": "90020230523204756343781000000000000001223372037583230452",
                    "type": "sapi",
            ...
            log={
                "data": {
                    ...
                    "details": {
                        ...
                        "response": {"body": {"enabled": True, "shields": "block"}, "statusCode": 400},
                    },
                    "ip": "12.12.12.12",
                    "log_id": "90020230523204756343781000000000000001223372037583230452",
                    "type": "sapi",
