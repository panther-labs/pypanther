...
class AWSEC2LaunchUnusualEC2Instances(Rule):
    ...
    def rule(self, event: PantherEvent) -> bool:
        return (
            ...
            and (self.get_instance_type(event) in self.get_unusual_instance_types())
        )
    ...
    def alert_context(self, event: PantherEvent) -> dict:
        ...
        context["instanceType"] = self.get_instance_type(event)
        return context

    def get_unusual_instance_types(self) -> set[str]:
    ...
    def get_instance_type(self, event: PantherEvent) -> str:
        # Return the type of the instance that was launch
        instance_type = event.deep_get("requestParameters", "instanceType", default="<UNKNOWN INSTANCE TYPE>")
