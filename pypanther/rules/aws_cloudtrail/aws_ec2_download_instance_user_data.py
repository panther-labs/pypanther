...
@panther_managed
class AWSEC2DownloadInstanceUserData(Rule):
    id = "AWS.EC2.DownloadInstanceUserData-prototype"
    ...
    tests = [
        RuleTest(
            ...
            log={
                ...
                "requestParameters": {"attribute": "userData", "instanceId": "i-12345678"},
                ...
                "userIdentity": {
                    ...
                    "sessionContext": {
                        "attributes": {"creationDate": "2024-12-11T21:49:04Z", "mfaAuthenticated": "false"},
                        "sessionIssuer": {
                            "accountId": "111122223333",
        ...
        RuleTest(
            ...
            log={
                ...
                "requestParameters": {"attribute": "userData", "instanceId": "i-1234567890abcdefa"},
                "sourceIPAddress": "1.2.3.4",
                "tlsDetails": {
                    "cipherSuite": "TLS_AES_128_GCM_SHA256",
                    "clientProvidedHostHeader": "ec2.us-west-2.amazonaws.com",
                ...
                "userIdentity": {
                    ...
                    "principalId": "SAMPLE_PRINCIPAL_ID:sample-session",
                    "sessionContext": {
                        "attributes": {"creationDate": "2024-12-12T21:43:11Z", "mfaAuthenticated": "false"},
                        "sessionIssuer": {
                            "accountId": "111122223333",
                            "arn": "arn:aws:iam::111122223333:role/SampleRole",
                            "principalId": "SAMPLE_PRINCIPAL_ID",
        ...
        RuleTest(
            ...
            log={
                ...
                "requestParameters": {"attribute": "userData", "instanceId": "i-1234123412341234"},
                ...
                "userIdentity": {
                    ...
                    "sessionContext": {
                        "attributes": {"creationDate": "2025-02-09T20:29:15Z", "mfaAuthenticated": "false"},
                        "sessionIssuer": {
                            "accountId": "123412341234",
