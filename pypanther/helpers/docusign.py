"""Used to define global helpers and variables for Docusign events."""
...
def docusign_alert_context(event) -> dict:
    return {
        ...
        "envelope_documents": [doc.get("name") for doc in event.deep_get("data", "envelopeDocuments", default=[])],
