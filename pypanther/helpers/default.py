"""DEPRECATED!!!  This helper and all its functions will be REMOVED on March 1, 2025. Please consult the docstrings of the functions for alternatives and migrate before then. The default global accessible via the Panther web UI."""
